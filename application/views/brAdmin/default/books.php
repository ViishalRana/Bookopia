											...
											<div class="col-sm-12">
												...
												<div class="card">
															...
															<table id="order-table" class="table table-striped table-bordered nowrap">
																<thead>
																	<tr>
																		<th>BookId</th>
																		<th>BookTitle</th>
																		<th>BookCoverPhoto</th>
																		<th>BookPages</th>
																		<th>BookEdition</th>
																		<th>BookPublisher</th>
																		<th>BookSynopsis</th>
																		<th>BookISBN</th>
																		<th>BookPublisherDate</th>
																		<th>View More</th>
																		<th>Manage</th>
													...
													foreach ($books as $key)
													{
														...
														<td><?= $key->bookID?></td>
														<td><?= $key->bookTitle?></td>
														<td><img src="<?= base_url();?>upload/<?= $key->bookCoverImage?>" height="100" width="100"></td>
														<td><?= $key->bookPages?></td>
														<td><?= $key->bookEdition ?></td>
														<td><?= $key->bookPublisherID?></td>
														<td><?= substr($key->bookSynopsis,0,50)?></td>
														<td><?= $key->bookISBN?></td>
														<td><?= $key->bookPublisherDate?></td>
														<td><a href="<?=site_url("brAdmin/BookC/bookMasterView/$key->bookID")?>"><button class='btn waves-effect waves-light btn-inverse btn-outline-inverse'><i class="fa fa-plus"></i>  View More</button></a></td>
														<td><a href="<?=site_url("brAdmin/BookC/editBook/$key->bookID")?>"><button class="bedit btn btn-primary btn-round waves-effect waves-light"><i class="fa fa-edit"></i></button></a>
														<a href="<?=site_url("brAdmin/BookC/deleteBook/$key->bookID")?>"><button class="btn btn-danger btn-round waves-effect waves-light"><i class="fa fa-trash"></i></button></a></td>
