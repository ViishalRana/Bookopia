...
<!-- Mirrored from colorlib.com//polygon/admindek/default/auth-sign-in-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jan 2019 05:53:51 GMT -->
...
<div class="col-sm-12">
    ...
    <form class="md-float-material form-material" method="post" action="<?= site_url("brAdmin/SignupC/login")?>">
