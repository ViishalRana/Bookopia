...
<!-- Mirrored from colorlib.com//polygon/admindek/default/auth-sign-up-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jan 2019 05:56:29 GMT -->
...
<link rel="stylesheet" href="resources/assets/pages/waves/css/waves.min.css" type="text/css" media="all"> <link rel="stylesheet" type="text/css" href="resources/assets/icon/feather/css/feather.css">
...
<link rel="stylesheet" type="text/css" href="resources/assets/css/style.css"><link rel="stylesheet" type="text/css" href="resources/assets/css/pages.css">
</head>
...
<div class="col-sm-12">
    ...
    <form class="md-float-material form-material" enctype="multipart/form-data" method="post" action="<?= site_url("brAdmin/SignupC/signup")?>">
    ...
    <div class="col-sm-6">
    <div class="form-group form-primary">
    <input type="password" name="txtcPassword" class="form-control" required="">
    <span class="form-bar"></span>
    ...
    <!-- <div class="col-sm-12"> -->
    <!-- <label class="float-label">Profile Photo</label> -->
    <div class="form-group form-primary">
    <input type="file" name="imgprofilePhoto" class="form-control" >
    <!-- <label class="float-label">Profile Photo</label> -->
    <span class="form-bar"></span>
    </div>
    <!-- </div> -->
           ...
           <!--  <div class="form-group row">
            <label class="col-sm-4 col-form-label">Book Cover Photo</label>
            <div class="col-sm-8">
...
<script type="text/javascript" src="resources/bower_components/i18next/js/i18next.min.js"></script>
<script type="text/javascript" src="resources/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
<script type="text/javascript" src="resources/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
<script type="text/javascript" src="resources/bower_components/jquery-i18next/js/jquery-i18next.min.js"></script>
