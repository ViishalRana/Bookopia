													...
													<div class="row col-md-12">  
														...
														foreach($searchData as $key)
														{
															...
															<div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
																<div class="tg-postbook" style="height: 300px;min-height: 0px;">
																	<figure class="tg-featureimg">
																		...
																		<div class="tg-bookimg">
																			<div class="tg-frontcover">
																				<img src="<?=base_url();?>upload/<?=$key->bookCoverImage?>" alt="image description" style="height: 200px;">
																			</div>
																			<div class="tg-backcover">
																				<img src="resources2/images/books/img-01.jpg" alt="image description">
																			</div>
																		</div>
																	...
																	<div class="tg-postbookcontent">
																		<div class="tg-booktitle">
																			<a href='<?=site_url('brUser/HomeC/viewMore/').$key->bookID?>'><h3><?=$key->bookTitle ?></h3></a>
															...
															<div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
																<div class="tg-postbook" style="height: 300px;min-height: 0px;">
																	<figure class="tg-featureimg">
																		...
																		<div class="tg-bookimg">
																			<div class="tg-frontcover">
																				<img src="<?=base_url();?>upload/<?=$key2->bookCoverImage?>" alt="image description" style="height: 200px;">
																			</div>
																			<div class="tg-backcover">
																				<img src="resources2/images/books/img-01.jpg" alt="image description">
																			</div>
																	...
																	<div class="tg-postbookcontent">
																		<div class="tg-booktitle">
																			<a href='<?=site_url('brUser/HomeC/viewMore/').$key2->bookID?>'><h3><?=$key2->bookTitle ?></h3></a>
				...
				$.ajax({
					...
					success:function(result)
					{
						...
						for (var data in key)
						{
							...
							htmlText+='</div>';
							htmlText+='</div>';
							htmlText+='<a class="tg-btnaddtowishlist" href="javascript:void(0);">';
							htmlText+='<i class="icon-heart"></i>';
							htmlText+='<span>add to wishlist</span>';
							htmlText+='</a>';
							htmlText+='</figure>';
							htmlText+='<div class="tg-postbookcontent">';
							htmlText+='<div class="tg-booktitle">';
